...
sidebar:
  order: 10
description: Upgrade your Agents SDK to AI SDK v6 with this comprehensive migration guide covering breaking changes, new features, and step-by-step instructions
---
...
For the Agents SDK, update your `package.json`:
...
- [Agents SDK GitHub repository](https://github.com/cloudflare/agents/issues)

...
<Tabs>
  <TabItem label="Execute Commands">
	...
	<TabItem label="Interactive Terminals">
		```typescript
		import { getSandbox } from '@cloudflare/sandbox';
		...
		Build interactive terminal experiences with full terminal emulation. Learn more: [Interactive Terminals](/sandbox/guides/interactive-terminals/).
	</TabItem>
...
<Feature header="Persistent storage with object storage" href="/sandbox/guides/mount-buckets/" cta="Learn about bucket mounting">
